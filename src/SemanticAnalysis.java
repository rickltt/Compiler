...
public class SemanticAnalysis {
    ...
    public static void Syntax(Syntax Cgramma) {
        Cgramma.Action_map.put("PUSH", 1);//压栈
        ...
        Cgramma.Action_map.put("IF", 12);// if
        Cgramma.Action_map.put("EL", 13);// else
        ...
        Cgramma.Action_map.put("SCANF", 22);
        Cgramma.Action_map.put("PRINTF", 23);
    }
        ...
        switch (Cgramma.Action_map.get(Action)) {
            ...
            case 2: { // GEQA动作
                ...
                if (!isdefined(tem.Second, table)) {
                    LL1Analysis.flag = false;
                    System.out.println(tem.Second + "未定义");
                } else if (!isdefined(tem.Third, table)) {
                    LL1Analysis.flag = false;
                    System.out.println(tem.Third + "未定义");
                }
                tem.Fourth = "t" + String.valueOf(LL1Analysis.i);
                Cgramma.qt.add(tem);
                GetTemLable(tem, table);
                Pair<String, Integer> _pair = new Pair<String, Integer>("t" + String.valueOf(LL1Analysis.i), TokenIndex);
                Cgramma.SEM.push(_pair);
                LL1Analysis.i++;
                break;
            }
