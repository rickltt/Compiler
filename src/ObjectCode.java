...
public class ObjectCode {
    public static void Blocked(Syntax Cgramma) {
        ...
        for (int i = 0; i < Cgramma.qt.size(); i++) {
            ...
            if (str.equals("if") || str.equals("el") || str.equals("ie") || str.equals("wh") || str.equals("do") || str.equals("we")||str.equals("PRINTF") ||str.equals("SCANF")) {
                Block.add(str);
                ...
                Block.add(str);
                int k=0;
                String[] qt_string =new String[100];
                for(int j=0;j<Block.size();j+=4){
                    qt_string[k++]="(";
                    qt_string[k++]=Block.get(j);
                    qt_string[k++]=",";
                    qt_string[k++]=Block.get(j+1);
                    qt_string[k++]=",";
                    qt_string[k++]=Block.get(j+2);
                    qt_string[k++]=",";
                    qt_string[k++]=Block.get(j+3);
                    qt_string[k++]=")";
                }
                Cgramma.code.add(qt_string);
